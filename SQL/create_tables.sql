...
DROP TABLE IF EXISTS PARTNERS,PRODUCTS,CONSUMERS,CONSUMER_PAYMENTS,CUSTOMERS,CUSTOMER_ADDRESSES,CUSTOMER_PHONES,CUSTOMER_PAYMENTS,ORDERS,ORDER_DETAILS ; 
...
CREATE TABLE REVIEWS (
    ...
    PRODUCT_NAME VARCHAR(32) REFERENCES PRODUCTS(PRODUCT_NAME) ON DELETE CASCADE,
    REVIEW_RATING INTEGER NOT NULL,
    REVIEW_CONTENT TEXT NOT NULL
    );

CREATE TABLE CUSTOMERS (
	CUSTOMER_USER_NAME 	VARCHAR(32) PRIMARY KEY,
...
CREATE TABLE CUSTOMER_PAYMENTS( 
	...
	CUSTOMER_USER_NAME VARCHAR(32) REFERENCES CUSTOMERS(CUSTOMER_USER_NAME) ON DELETE CASCADE,
...
CREATE TABLE ORDERS (
	...
	CUSTOMER_USER_NAME VARCHAR(32) REFERENCES CUSTOMER(CUSTOMER_USER_NAME) ON DELETE CASCADE,
...
INSERT INTO CUSTOMERS (CUSTOMER_USER_NAME,CUSTOMER_FIRST_NAME,CUSTOMER_LAST_NAME) VALUES
	('MRS_HOPEFUL@YAHOO.COM','JENNY','GUMP');
\echo 'CREATED A CUSTOMER';
SELECT * FROM CUSTOMER ; 

INSERT INTO ORDERS (CUSTOMER_USER_NAME) VALUES 
	('MRS_HOPEFUL@YAHOO.COM');
\echo 'CREATED AN ORDER: ' ; 
SELECT * FROM ORDERS ; 

INSERT INTO ORDER_DETAILS (ORDER_ID,CUSTOMER_USER_NAME,PRODUCT_ID) VALUES
